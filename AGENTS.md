...
- Whenever a set of modifications is finished, create a change log entry in `.change_log/` using this ISO 8601:2019 filename pattern: `[YYYY-MM-DDTHH-mm-ss]-[change-description].md`. Use local time, hyphens instead of colons in the time component, and a short kebab-case description, for example `.change_log/2026-05-25T20-17-46-add-agent-docs.md`.
