...
export const zhCN: TranslationTree = {
  ...
  alfredImport: {
    ...
    importCount: "导入选中的 {{count}} 项",
    importSuccess: "成功导入 {{count}} 个 Snippet！",
    trigger: "触发词",
    replace: "替换内容",
    name: "名称/描述",
  },
  ...
  snippets: {
    ...
    imageFilesFilter: "图片",
    emptyForm: "空表单",
    emptyReplacement: "空替换文本",
    viewDetailsFor: "查看 {{trigger}} 的详细信息",
  ...
  dateFormats: {
    addDate: "插入日期",
    iso8601: "国际标准型 (ISO 8601)",
    slashUs: "日常斜线型 (美式 MM/DD/YYYY)",
    slashUk: "日常斜线型 (英式 DD/MM/YYYY)",
    dotEu: "点号分割型 (欧式 DD.MM.YYYY)",
    textUs: "文本长格式 (美式 Jun 18, 2025)",
  ...
  errors: {
    ...
    espansoPathBlocked:
      "已解析 Espanso 路径，但 Tauri 阻止了文件访问。请将 Espanso match 目录加入文件系统权限范围，然后重启应用。（{{message}}）",
    ...
    imageFileNotAllowed:
      "所选文件是图片。文件标签页仅支持纯文本文件。请切换到图片标签页添加图片片段。",
  ...
  search: {
    ...
    openSearch: "搜索片段... ({{shortcut}})",
    searchingStatus: "正在搜索...",
    matchedIn: "匹配于",
